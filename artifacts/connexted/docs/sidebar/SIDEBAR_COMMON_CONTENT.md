# Sidebar Section: Common Content

> This sidebar section is dynamically filtered — it only shows content types the user's class is permitted to access, as configured in the Container Configuration matrix.
