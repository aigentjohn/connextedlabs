> ⚠️ **SUPERSEDED** — Replaced by [SIDEBAR_SETUP.md](SIDEBAR_SETUP.md) to match the actual sidebar section name. This file is kept for reference only.

# Sidebar Section: Admin / Setup
