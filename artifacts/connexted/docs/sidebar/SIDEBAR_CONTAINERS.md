> ⚠️ **SUPERSEDED** — Replaced by [SIDEBAR_COMMON_CONTAINERS.md](SIDEBAR_COMMON_CONTAINERS.md) to match the actual sidebar section name. This file is kept for reference only.

# Sidebar Section: Container Types
