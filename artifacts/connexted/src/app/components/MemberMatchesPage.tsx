...
const MOCK_MEMBERS: MockMember[] = [
  {
    ...
    name: 'Sarah Chen',
    avatar: null,
    tagline: 'Automation PM | Capital Equipment | ISA Member',
    job_title: 'Senior Automation Project Manager',
    company: 'Rockwell Automation',
    years_experience: 14,
    career_stage: 'senior-leader',
    interests: ['AI in Manufacturing', 'Automation Project Management', 'Capital Equipment'],
    skills: ['PLC Programming', 'SCADA Systems', 'Risk Management', 'Change Management'],
    credentials: ['PMP', 'ISA-CCST'],
    affiliations: ['ISA', 'PMI'],
    ...
    matchReasons: [
      ...
      { label: 'Shared affiliation: ISA', source: 'professional' },
      { label: 'Shared interest: AI in Manufacturing', source: 'engagement' },
  ...
  },
  {
    ...
    name: 'Marcus Webb',
    avatar: null,
    tagline: 'Machinery Safety Engineer | OSHA Expert | Mentor',
    job_title: 'Principal Safety Engineer',
    company: 'Siemens Energy',
    years_experience: 18,
    career_stage: 'senior-leader',
    interests: ['Safety in Electrical Contractors', 'Industrial Safety', 'Leadership Development'],
    skills: ['Hazard Analysis', 'Machine Guarding', 'Safety Program Development'],
    credentials: ['CSP', 'PMP'],
    affiliations: ['ASSE', 'ISA', 'NFPA'],
  ...
  },
  {
    ...
    avatar: null,
    tagline: 'Industrial IoT Consultant | Data Analytics | Georgia Tech ATDC',
    job_title: 'IoT Strategy Consultant',
    company: 'Project Journeys LLC',
    years_experience: 12,
    career_stage: 'coach-consultant',
    interests: ['Industrial IoT', 'AI in Manufacturing', 'Data Analysis in Construction'],
    skills: ['IoT Architecture', 'Data Analytics', 'Business Development', 'Workshop Facilitation'],
    credentials: ['PMP', 'AWS Certified'],
    affiliations: ['Georgia Tech ATDC', 'ISA'],
    looking_for: ['collaboration', 'visibility'],
    score: 81,
    matchReasons: [
      { label: 'Shared affiliation: Georgia Tech ATDC', source: 'professional' },
      { label: 'Shared affiliation: ISA', source: 'professional' },
      { label: 'Shared interest: AI in Manufacturing', source: 'engagement' },
  ...
  },
  {
    ...
    name: 'David Park',
    avatar: null,
    tagline: 'Capital Equipment PM | Power Generation | 20+ Years',
    job_title: 'Program Manager, Capital Projects',
    company: 'Metso Outotec',
    years_experience: 22,
    career_stage: 'senior-leader',
    interests: ['Capital Equipment Project Management', 'Power Generation', 'PMO Leadership'],
    skills: ['Program Management', 'Earned Value Management', 'Stakeholder Engagement'],
    credentials: ['PMP', 'PgMP'],
    affiliations: ['PMI', 'IEEE'],
    looking_for: ['peer-support', 'skill-building'],
    score: 78,
    matchReasons: [
      { label: 'Shared interest: Capital Equipment PM', source: 'engagement' },
      { label: 'Shared credential: PMP', source: 'professional' },
      { label: 'Aligned: Program Manager role', source: 'professional' },
      { label: 'Both looking for: Peer Support', source: 'engagement' },
    ],
  },
  {
    ...
    name: 'Priya Nair',
    avatar: null,
    tagline: 'Smart Manufacturing | Leadership Coach | ISA Volunteer',
    job_title: 'Director of Smart Manufacturing',
    company: 'ABB',
    years_experience: 16,
    career_stage: 'senior-leader',
    interests: ['Smart Manufacturing', 'AI in Manufacturing', 'Leadership Development', 'Industrial IoT'],
    skills: ['Digital Transformation', 'Team Leadership', 'Manufacturing Execution Systems'],
    credentials: ['Lean Six Sigma Black Belt', 'PMP'],
    affiliations: ['ISA', 'MESA International'],
  ...
  },
  {
    ...
    name: 'Tom Gallagher',
    avatar: null,
    tagline: 'Emerging PM | Automation | Seeking Mentorship',
    job_title: 'Project Engineer',
    company: 'Emerson Electric',
    years_experience: 4,
    career_stage: 'established',
    interests: ['Automation Project Management', 'AI in Manufacturing', 'Career Development'],
    skills: ['Project Coordination', 'AutoCAD', 'PLC Basics'],
    credentials: ['CAPM'],
    affiliations: ['ISA', 'PMI'],
    ...
    matchReasons: [
      { label: 'Shared affiliation: ISA', source: 'professional' },
      { label: 'Shared interest: Automation PM', source: 'engagement' },
