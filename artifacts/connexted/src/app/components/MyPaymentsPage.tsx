...
export default function MyPaymentsPage() {
  ...
  const canUpgrade = profile.membership_tier !== 'premium';
  const canDowngrade = profile.membership_tier !== 'free';

  return (
    <div className="space-y-6">
      <Breadcrumbs items={[{ label: 'My Payments' }]} />

      {/* Header */}
      <div>
        <h1 className="text-3xl mb-2">My Payments</h1>
        <p className="text-gray-600">
          Manage your membership tier and billing information
        </p>
      </div>
      ...
      {canUpgrade && (
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Free Plan */}
            <Card className={profile.membership_tier === 'free' ? 'border-2 border-indigo-600' : ''}>
              <CardHeader>
            ...
            {/* Member Plan */}
            <Card className={profile.membership_tier === 'member' ? 'border-2 border-indigo-600' : ''}>
              <CardHeader>
                <div className="flex items-center gap-2 mb-2">
                  {getTierIcon('member')}
              ...
              <CardContent>
                ...
                {profile.membership_tier === 'member' ? (
                  ...
                  <Button className="mt-4 w-full">
                    {profile.membership_tier === 'free' ? 'Upgrade' : 'Downgrade'}
                  </Button>
                )}
              </CardContent>
            </Card>
            ...
            {/* Premium Plan */}
            <Card className={profile.membership_tier === 'premium' ? 'border-2 border-yellow-600' : 'border-2 border-yellow-200'}>
