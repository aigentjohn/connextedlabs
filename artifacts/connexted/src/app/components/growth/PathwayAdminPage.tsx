...
const ACTIVITY_TABLE_MAP: Record<string, { table: string; titleField: string } | null> = {
  ...
  create_build:        { table: 'builds',         titleField: 'name'  },
  give_pitch:          { table: 'pitches',        titleField: 'name'  },
  join_meetup:         { table: 'meetups',        titleField: 'name'  },
  participate_standup: { table: 'standups',       titleField: 'name'  },
  join_sprint:         { table: 'sprints',        titleField: 'name'  },
